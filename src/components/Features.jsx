  ...
  return (
    <div className="relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div>
          <h1 className="bento-title speccial-font">{title}</h1>
          {description && (
      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          <p className="font-circular-web text-5xl text-blue-50">
            Into the Metagauge Layer
          </p>
          <p className="max-w-md font-circular-web text-2xl text-blue-50 opacity-50 mt-2">
        ...
        >
          <BentoCard
            ...
            description="A Cross Platform metagae app, turning your 
            activities across Web2 and Web3 games into a rewarding adventures"
          />
        </BentoTilt>
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description="A Gamified social hub,
               adding a new dimension of play to social
